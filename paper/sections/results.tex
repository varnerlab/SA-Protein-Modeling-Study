...
We assessed structural plausibility by predicting folded structures for 50 sequences per method per family using ESMFold (Fig.~\ref{fig:structure-validation}). We compared SA generation to stored (natural) sequences using Wilcoxon rank-sum tests with Cohen's $d$ effect sizes.
