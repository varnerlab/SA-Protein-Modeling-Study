...
\begin{table}[t]
\centering
\caption{Generation metrics across seven Pfam families (mean $\pm$ SE). SA gen: stochastic attention generation regime ($\beta \approx 2\beta^*$). SA ret: retrieval regime ($\beta \approx 20\beta^*$). BS: bootstrap. GP: Gaussian perturbation. CC: convex combination. KL: KL divergence of amino acid composition (lower is better; SE via 1{,}000-fold bootstrap). Novelty: $1 - \max_k\cos(\hat{\boldsymbol{\xi}}, \mathbf{m}_k)$ in PCA space (higher means more novel). SeqID: nearest sequence identity after decoding. Standard errors for novelty and SeqID are computed over 30 independent chains of 5 samples each.}
\label{tab:results}
\small
\begin{tabular}{@{}llccc@{}}
\toprule
...
\midrule
\multirow{5}{*}{RRM}
 & SA gen  & $\mathbf{0.060 \pm 0.005}$ & $0.513 \pm 0.011$ & $0.538 \pm 0.006$ \\
...
\midrule
\multirow{5}{*}{SH3}
 & SA gen  & $\mathbf{0.036 \pm 0.004}$ & $0.471 \pm 0.012$ & $0.593 \pm 0.006$ \\
...
\midrule
\multirow{5}{*}{WW}
 & SA gen  & $\mathbf{0.008 \pm 0.002}$ & $0.653 \pm 0.006$ & $0.562 \pm 0.005$ \\
...
\midrule
\multirow{5}{*}{Kunitz}
 & SA gen  & $\mathbf{0.013 \pm 0.002}$ & $0.557 \pm 0.009$ & $0.607 \pm 0.004$ \\
...
\midrule
\multirow{5}{*}{zf-C2H2}
 & SA gen  & $\mathbf{0.013 \pm 0.028}$ & $0.596 \pm 0.010$ & $0.557 \pm 0.007$ \\
...
\midrule
\multirow{5}{*}{PDZ}
 & SA gen  & $\mathbf{0.038 \pm 0.010}$ & $0.418 \pm 0.009$ & $0.543 \pm 0.005$ \\
...
\midrule
\multirow{5}{*}{Pkinase}
 & SA gen  & $\mathbf{0.035 \pm 0.001}$ & $0.478 \pm 0.011$ & $0.515 \pm 0.004$ \\
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figs/cross_family_kl.pdf}
\caption{Amino acid composition fidelity across seven Pfam families. KL divergence between the residue frequency distributions of generated and stored sequences (lower is better). SA generation consistently achieves the lowest KL divergence, preserving family-level composition while producing novel sequences.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figs/scaling_kl_vs_k.pdf}
\caption{Generation quality as a function of family size. The WW domain was subsampled at $K \in \{20, 50, 100, 200, 400\}$ with five independent replicates per condition. Error bars show $\pm 1$ SE. Note the log scale on both axes: SA generation (blue) maintains low KL divergence across the entire range, while the convex combination baseline (purple) degrades catastrophically.}
\label{fig:scaling}
\end{figure}
