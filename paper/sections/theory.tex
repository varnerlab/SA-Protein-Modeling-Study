...
\end{equation}
is the softmax attention retrieval map~\cite{ramsauerHopfieldNetworksAll2021}. The Boltzmann distribution $p_\beta(\boldsymbol{\xi}) \propto \exp(-\beta\,E(\boldsymbol{\xi}))$ has score function given by:
